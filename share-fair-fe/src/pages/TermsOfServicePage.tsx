...
const TermsOfServicePage = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      <SEO title={t('terms.title')} description="Sharefair terms of service — rules and guidelines for using the platform." />
      <h1 className="text-3xl font-bold mb-2">{t('terms.title')}</h1>
      <p className="text-gray-500 dark:text-gray-400 mb-8">{t('terms.lastUpdated')}</p>

      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3">{t('terms.acceptanceTitle')}</h2>
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{t('terms.acceptanceText')}</p>
      </section>

      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3">{t('terms.eligibilityTitle')}</h2>
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{t('terms.eligibilityText')}</p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{t('terms.prohibitedText')}</p>
      </section>

      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-3">{t('terms.environmentTitle')}</h2>
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{t('terms.environmentText')}</p>
      </section>
    </div>
  )
}
