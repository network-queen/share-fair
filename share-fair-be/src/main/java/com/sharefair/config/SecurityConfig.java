    ...
    public SecurityFilterChain filterChain(HttpSecurity http, CorsConfigurationSource corsConfigurationSource) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/sustainability/report/community").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/sustainability/report/user/**").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/v1/disputes").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/v1/disputes/**").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/api/v1/disputes/**").authenticated()
